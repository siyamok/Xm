...
print('\033[97;1m[\x1b[38;5;50m+\033[97;1m] \x1b[38;5;50mISRAEL ER MA RE CDI🦶🇮🇱 ')
os.system("espeak -a 300 \"Israel,er,mare,chudi,\"")
time.sleep(2)
#os.system('clear')
print('\033[97;1m[\x1b[38;5;50m+\033[97;1m] \x1b[38;5;50mARE YOU READY?...! ')
os.system("espeak -a 300 \"ARE YOU READY?,\"")
time.sleep(2)
#os.system('clear')
print("\033[97;1m[\x1b[38;5;50m+\033[97;1m]\x1b[38;5;50m GAME PLAY ..!")
os.system("espeak -a 300 \"GAME PLAY,\"")
time.sleep(2)
...
prinCP=[]
try:
    prox= requests.get('https://github.com/siyamok/Xm/blob/main/X.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/sexsiyam/approval./blob/main/approval').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://facebook.com/groups/1962972697410328/')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/sexsiyam/approval./blob/main/approval').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      print('\033[92;1m┏━\033[97;1m[\033[92;1m+\033[97;1m] \033[97;1mSIYAM NAME OF BRAND')
      ...
      print('\033[92;1m┗━\033[97;1m[\033[92;1m+\033[97;1m] \033[92;1mFULL FREE TOOL ')
      print('\033[92;1m┏━\033[97;1m[\033[92;1m+\033[97;1m] \033[97;1mAddiction to make money is the greatest addiction of human civilization ')
